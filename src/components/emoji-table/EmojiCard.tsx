...
export function EmojiCard({ emoji, onClick }: EmojiCardProps) {
  return (
    <div className="pb-100% relative">
      <button
        className="flex flex-col items-center shadow rounded p-2 bg-white absolute top-0 w-full h-full focus:outline-none hover:bg-orange-300 transition duration-300"
        onClick={() => {
          onClick(emoji);
        }}>
